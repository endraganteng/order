                ...
                <tbody>
                    ...
                    @php
                        ...
                        $typeLabel = match($type) {
                            ...
                            'cash_payout' => '💵 Bayar Tunai',
                            'kasbon_disbursement' => '📤 Kasbon',
                            'kasbon_deduct' => '📥 Potong Kasbon',
                            'withdrawal' => '💸 Penarikan',
                            default => $type,
                        };
                        $amount = (int) ($tx['amount'] ?? 0);
                        $isOut = in_array($type, ['withdrawal', 'cash_payout', 'kasbon_disbursement', 'kasbon_deduct'], true);
                        $status = $tx['status'] ?? '';
